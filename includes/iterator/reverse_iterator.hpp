...
namespace ft {
	template <class Iterator> class reverse_iterator {
		public:
			...
			// Copy constructor
			template <class Iter> reverse_iterator (const reverse_iterator<Iter>& rev_it) : _it(rev_it.base()) {};
	...
	// Operator overloads
	template <class Iterator>
        reverse_iterator<Iterator> operator+ (const reverse_iterator<Iterator>& lhs,
                typename reverse_iterator<Iterator>::difference_type n)
        {
            return (lhs + n);
        }
	template <typename T>
        ft::reverse_iterator<T> operator+(typename ft::reverse_iterator<T>::difference_type n,
